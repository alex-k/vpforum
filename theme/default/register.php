...
<tr class="vt RowStyleA"><td>Файл с картинкой: '.draw_err('avatar').'</td><td>
	...
	$mppg_select		= tmpl_draw_select_opt("0\n5\n10\n20\n30\n40\n50\n100\n200\n400\n1000", "Использовать умолчания форума\n5\n10\n20\n30\n40\n50\n100\n200\n400\n1000", $reg_posts_ppg);
...
<tr><td>
	<label>ICQ<br /><img src="theme/default/images/icq<?php echo img_ext; ?>" alt="" /><input type="text" name="reg_icq" value="<?php echo $reg_icq; ?>" maxlength="32" size="25" /></label>
</td><td>
	<label>Имя в сети AIM:<br /><img src="theme/default/images/aim<?php echo img_ext; ?>" alt="" /><input type="text" name="reg_aim" value="<?php echo $reg_aim; ?>" maxlength="32" size="25" /></label>
</td></tr><tr><td>
	<label>Имя в сети Yahoo:<br /><img src="theme/default/images/yahoo<?php echo img_ext; ?>" alt="" /><input type="text" name="reg_yahoo" value="<?php echo $reg_yahoo; ?>" maxlength="32" size="25" /></label>
</td><td>
	<label>Имя в сети MSN:<br /><img src="theme/default/images/msnm<?php echo img_ext; ?>" alt="" /><input type="text" name="reg_msnm" value="<?php echo $reg_msnm; ?>" maxlength="32" size="25" /></label>
</td></tr><tr><td>
	<label>Имя в сети Jabber:<br /><img src="theme/default/images/jabber<?php echo img_ext; ?>" alt="" /><input type="text" name="reg_jabber" value="<?php echo $reg_jabber; ?>" maxlength="32" size="25" /></label>
</td><td>
	<label>Имя в сети Google Chat/IM:<br /><img src="theme/default/images/google<?php echo img_ext; ?>" alt="" /><input type="text" name="reg_google" value="<?php echo $reg_google; ?>" maxlength="32" size="25" /></label>
</td></tr><tr><td>
	<label>Имя в Skype:<br /><img src="theme/default/images/skype<?php echo img_ext; ?>" alt="" /><input type="text" name="reg_skype" value="<?php echo $reg_skype; ?>" maxlength="32" size="25" /></label>
</td><td>
	<label>Прозвище в Twitter:<br /><img src="theme/default/images/twitter<?php echo img_ext; ?>" alt="" /><input type="text" name="reg_twitter" value="<?php echo $reg_twitter; ?>" maxlength="32" size="25" /></label>
