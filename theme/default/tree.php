...
<td>'.((_uid && $cur->post_stamp > $usr->last_read && $cur->post_stamp > $frm->last_view) ? '<img id="msgIm'.$cur->id.'" src="theme/default/images/unread'.img_ext.'" alt="Сообщение прочитано" title="Сообщение прочитано" />' : '<img src="theme/default/images/read'.img_ext.'" alt="Сообщение не прочитано" title="Сообщение не прочитано" />' ) .'</td>
...
<td class="vb ar"><a href="index.php?t=msg&amp;th=<?php echo $th; ?>&amp;<?php echo _rsid; ?>#msg_<?php echo $mid; ?>"><img alt="Вернуться к плоскому виду по умолчанию" title="Вернуться к плоскому виду по умолчанию" src="theme/default/images/flat_view.gif" /></a>&nbsp;<a href="index.php?t=post&amp;frm_id=<?php echo $frm->forum_id; ?>&amp;<?php echo _rsid; ?>"><img alt="Создать новую тему" src="theme/default/images/new_thread.gif" /></a><?php echo ((!($frm->thread_opt & 1) || $perms & 4096) ? '&nbsp;<a href="index.php?t=post&amp;th_id='.$th.'&amp;reply_to='.$mid.'&amp;'._rsid.'"><img alt="Отправить ответ" src="theme/default/images/post_reply.gif" /></a>' : ''); ?></td>
</tr>
</table>
...
<div class="ar SmallText"><?php echo ($FUD_OPT_2 & 1048576 ? '[ <a href="index.php?t=help_index&amp;section=boardusage#syndicate">Сформировать XML</a> ] [ <a href="feed.php?mode=m&amp;th='.$th.'&amp;basic=1"><img src="theme/default/images/rss.gif" title="Сформировать XML" alt="RSS" /></a> ]' : ''); ?> <?php echo ($FUD_OPT_2 & 2097152 ? '[ <a href="'.$GLOBALS['WWW_ROOT'].'pdf.php?msg='.$mid.'&amp;'._rsid.'"><img src="theme/default/images/pdf.gif" title="Сформировать PDF для печати" alt="PDF" /></a> ]' : ''); ?></div>
