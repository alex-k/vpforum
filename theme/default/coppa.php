...
<tr><th>Подтверждение COPPA</th></tr>
<tr class="RowStyleA GenText ac"><td>
Выберите ссылку, правильно указывающую на дату вашего рождения<br /><br />
[<a href="index.php?t=pre_reg&amp;coppa=&amp;<?php echo _rsid; ?>">Ранее <?php echo strftime("%B %#d, %Y", $coppa); ?></a>]&nbsp;
[<a href="index.php?t=pre_reg&amp;coppa=1&amp;<?php echo _rsid; ?>">После <?php echo strftime("%B %#d, %Y", $coppa); ?></a>]
<hr/>
<p>Для завершения регистрации на форуме детей в возрасте до 13 лет требуется получение по факсу или почте подписанного разрешения от родителей или опекунов.</p><p>Для получения дополнительной информации обращайтесь по <a href="mailto:<?php echo $GLOBALS['ADMIN_EMAIL']; ?>"><?php echo $GLOBALS['ADMIN_EMAIL']; ?></a></p>
</td></tr>
</table></div>
