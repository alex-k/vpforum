...
<td class="nw GenText"><a href="index.php?t=usrinfo&amp;id='.$r->id.'&amp;'._rsid.'">'.draw_user_link($r->alias, $r->users_opt, $r->custom_color).'</a>'.($r->users_opt & 131072 ? '' : '&nbsp;&nbsp;(неподтвержденный участник)' ) .'</td><td class="ac nw">'.$r->posted_msg_count.'</td><td class="DateText nw">'.strftime("%a, %d %B %Y", $r->join_date).'</td><td class="nw GenText"><a href="index.php?t=showposts&amp;id='.$r->id.'&amp;'._rsid.'"><img alt="" src="theme/default/images/show_posts.gif" /></a>
