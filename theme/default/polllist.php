...
if (_uid) {
	...
	while ($obj = db_rowobj($c)) {
		...
		if ($obj->owner && (!($obj->users_opt & 32768) || $is_a) && $FUD_OPT_2 & 32) {
			$online_indicator = $obj->last_visit > __request_timestamp__ ? '<img src="theme/default/images/online'.img_ext.'" title="онлайн" alt="онлайн" />&nbsp;' : '<img src="theme/default/images/offline'.img_ext.'" title="оффлайн" alt="оффлайн" />&nbsp;';
		} else {
			$online_indicator = '';
		}
