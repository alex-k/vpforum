...
<td class="nw GenText"><a href="index.php?t=usrinfo&amp;id='.$r->id.'&amp;'._rsid.'">'.draw_user_link($r->alias, $r->users_opt, $r->custom_color).'</a>'.($r->users_opt & 131072 ? '' : '&nbsp;&nbsp;(неподтвержденный участник)' ) .'</td><td class="ac nw">'.$r->posted_msg_count.'</td><td class="DateText nw">'.strftime("%a, %d %B %Y", $r->join_date).'</td><td class="nw GenText"><a href="index.php?t=showposts&amp;id='.$r->id.'&amp;'._rsid.'"><img alt="" src="theme/velopiter/images/show_posts.gif" /></a>
'.(($FUD_OPT_2 & 1073741824 && $r->users_opt & 16) ? '<a href="index.php?t=email&amp;toi='.$r->id.'&amp;'._rsid.'" rel="nofollow"><img src="theme/velopiter/images/msg_email.gif" alt="" /></a>' : '' ) .'
'.(($FUD_OPT_1 & 1024 && _uid) ? '<a href="index.php?t=ppost&amp;'._rsid.'&amp;toi='.$r->id.'"><img src="theme/velopiter/images/msg_pm.gif" alt="" /></a>' : '' ) .'
'.($r->home_page ? '<a href="'.$r->home_page.'" rel="nofollow"><img alt="" src="theme/velopiter/images/homepage.gif" /></a>' : '' ) .'</td>'.($is_a ? '<td class="SmallText nw"><a href="'.$GLOBALS['WWW_ROOT'].'adm/admuser.php?usr_id='.$r->id.'&amp;S='.s.'&amp;act=1&amp;SQ='.$GLOBALS['sq'].'">Править</a> || <a href="'.$GLOBALS['WWW_ROOT'].'adm/admuser.php?usr_id='.$r->id.'&amp;S='.s.'&amp;act=del&amp;f=1&amp;SQ='.$GLOBALS['sq'].'">Удалить</a> || '.($r->users_opt & 65536 ? '<a href="'.$GLOBALS['WWW_ROOT'].'adm/admuser.php?act=block&amp;usr_id='.$r->id.'&amp;S='.s.'&amp;SQ='.$GLOBALS['sq'].'">Разрешить</a>' : '<a href="'.$GLOBALS['WWW_ROOT'].'adm/admuser.php?act=block&amp;usr_id='.$r->id.'&amp;S='.s.'&amp;SQ='.$GLOBALS['sq'].'">Запретить</a>' ) .'</td>' : '' ) .'</tr>';
	}
	unset($c);
	if (!$find_user_data) {
