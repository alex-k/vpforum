...
if (__fud_real_user__ && $FUD_OPT_1 & 1024) {	// PM_ENABLED
	...
	if (isset($usr->data['er_msg'], $usr->data['err_t'])) {
		...
		$error_message	= 'Недопустимый URL';
		$error_title	= 'Ошибка';
	}
...
<br /><br /><form action="index.php?t=error" id="error_frm" method="post"><?php echo _hs; ?><input type="submit" class="button" name="ok" value="OK" /></form>
</td></tr>
</table></div>
