...
<td class="RowStyleB wo"><img src="theme/velopiter/images/moved'.img_ext.'" title="Эта тема была перенесена в другой форум" alt="" /></td>
<td class="RowStyleB ac GenText" colspan="5"><a href="index.php?t='.d_thread_view.'&amp;goto='.$r[15].'&amp;'._rsid.'#msg_'.$r[15].'">'.$r[2].'</a> перенесено модератором в <a href="index.php?t='.t_thread_view.'&amp;frm_id='.$r[11].'&amp;'._rsid.'">'.$r[12].'</a></td>
			...
			if (_uid && $usr->last_read < $r[10] && $r[10] > $r[20]) {
				$thread_read_status = ($r[18] & 1) ? '<img src="theme/velopiter/images/unreadlocked'.img_ext.'" title="Закрытая тема с непрочитанными сообщениями" alt="" />' : '<img src="theme/velopiter/images/unread'.img_ext.'" title="Эта тема содержит не прочитанные вами сообщения" alt="" />';
				/* Do not show 1st unread message link if thread has no replies. */
				if ($r[16]) {
					$first_unread_msg_link = '<a href="index.php?t='.d_thread_view.'&amp;th='.$r[13].'&amp;unread=1&amp;'._rsid.'"><img src="theme/velopiter/images/newposts.gif" title="Перейти к первому непрочитанному сообщению в этой теме" alt="" /></a>&nbsp;';
				}
			} else if ($r[18] & 1) {
				$thread_read_status = '<img src="theme/velopiter/images/readlocked'.img_ext.'" title="Эта тема была закрыта" alt="" />';
			} else if (!_uid) {
				$thread_read_status = '<img src="theme/velopiter/images/read'.img_ext.'" title="Отслеживание прочитанных и непрочитанных сообщений доступно только зарегистрированным участникам" alt="" />';
			} else {
				$thread_read_status = '<img src="theme/velopiter/images/read'.img_ext.'" title="В этой теме нет непрочитанных сообщений" alt="" />';
			}
...
<td class="RowStyleA">'.(($r[18] > 1) ? ($r[18] & 4 ? '<span class="StClr">стикер:&nbsp;</span>' : '<span class="AnClr">анонс:&nbsp;</span>' )  : '' ) .$first_unread_msg_link.($r[1] ? 'Голосование:&nbsp;' : '' ) .($r[0] ? '<img src="theme/velopiter/images/attachment.gif" alt="" />' : '' ) .'<a class="big" href="index.php?t='.d_thread_view.'&amp;th='.$r[13].'&amp;start=0&amp;'._rsid.'">'.$r[2].'</a>'.($r[22] ? '<br /><span class="small">'.$r[22].'</span>' : '' )  .' '.((($FUD_OPT_2 & 4096) && $r[17]) ? ($MOD || $mo == 8224 ? '<a href="javascript://" onclick="window_open(\''.$GLOBALS['WWW_ROOT'].'index.php?t=ratingtrack&amp;'._rsid.'&amp;th='.$r[13].'\', \'th_rating_track\', 300, 400);">' : '' ) .'<img src="theme/velopiter/images/'.$r[17].'stars.gif" title="'.$r[17].' из '.convertPlural($r[21], array(''.$r[21].' голоса',''.$r[21].' голосов',''.$r[21].' голосов')).'" alt="" />'.($MOD || $mo == 8224 ? '</a>' : '' ) : '' ) .' '.$mini_thread_pager.' <div class="TopBy">От: '.($r[5] ? '<a href="index.php?t=usrinfo&amp;id='.$r[6].'&amp;'._rsid.'">'.$r[5].'</a>' : $GLOBALS['ANON_NICK'].'' ) .' - <span class="DateText">'.strftime("%a, %d %B %Y", $r[4]).'</span></div>'.$admin_control_row.'</td>
<td class="RowStyleB ac">'.$r[16].'</td>
<td class="RowStyleB ac">'.$r[19].'</td>
<td class="RowStyleC nw"><span class="DateText">'.strftime("%a, %d %B %Y %H:%M", $r[10]).'</span><br />От: '.($r[8] ? '<a href="index.php?t=usrinfo&amp;id='.$r[7].'&amp;'._rsid.'">'.$r[8].'</a>' : $GLOBALS['ANON_NICK'].'' ) .' <a href="index.php?t='.d_thread_view.'&amp;th='.$r[13].'&amp;goto='.$r[9].'&amp;'._rsid.'#msg_'.$r[9].'"><img src="theme/velopiter/images/goto.gif" title="Перейти к последнему сообщению в этой теме" alt="" /></a></td>
</tr>';
...
<td class="GenText nw vb ar"><?php echo ($FUD_OPT_2 & 512 ? '<a href="index.php?t=threadt&amp;frm_id='.$frm->id.'&amp;'._rsid.'"><img title="древовидный вид" alt="древовидный вид" src="theme/velopiter/images/tree_view.gif" /></a>&nbsp;' : ''); ?><a href="index.php?t=post&amp;frm_id=<?php echo $frm->id; ?>&amp;<?php echo _rsid; ?>"><img src="theme/velopiter/images/new_thread.gif" alt="Создать новую тему" /></a></td>
</tr></table>
...
[ <a href="feed.php?mode=m&amp;l=1&amp;basic=1&amp;frm='.$frm->id.'&amp;n=10"><img src="theme/velopiter/images/rss.gif" title="Сформировать XML" alt="RSS" /></a> ]' : '' ) .(($FUD_OPT_2 & 270532608) == 270532608 ? '&nbsp;[ <a href="'.$GLOBALS['WWW_ROOT'].'pdf.php?frm='.$frm->id.'&amp;page='.$cur_frm_page.'&amp;'._rsid.'"><img src="theme/velopiter/images/pdf.gif" title="Сформировать PDF для печати" alt="PDF" /></a> ]' : '' )  .'</div>
' : '
	<div class="ar SmallText">'.(($FUD_OPT_2 & 270532608) == 270532608 ? '&nbsp;[ <a href="'.$GLOBALS['WWW_ROOT'].'pdf.php?frm='.$frm->id.'&amp;page='.$cur_frm_page.'&amp;'._rsid.'"><img src="theme/velopiter/images/pdf.gif" title="Сформировать PDF для печати" alt="PDF" /></a> ]' : '' ) .($FUD_OPT_2 & 1048576 ? '&nbsp;[ <a href="index.php?t=help_index&amp;section=boardusage#syndicate">Сформировать XML</a> ]
[ <a href="feed.php?mode=m&amp;l=1&amp;basic=1&amp;frm='.$frm->id.'&amp;n=10"><img src="theme/velopiter/images/rss.gif" title="Сформировать XML" alt="RSS" /></a> ]' : '' )  .'</div>
'); ?>
<fieldset>
        <legend>Легенда:</legend>
<img src="theme/velopiter/images/unread<?php echo img_ext; ?>" alt="Новые сообщения" />&nbsp;Новые сообщения&nbsp;&nbsp;
<img src="theme/velopiter/images/read<?php echo img_ext; ?>" alt="Нет новых сообщений" />&nbsp;Нет новых сообщений&nbsp;&nbsp;
<img src="theme/velopiter/images/unreadlocked<?php echo img_ext; ?>" alt="Тема закрыта (есть непрочитанные сообщения)" />&nbsp;Тема закрыта (есть непрочитанные сообщения)&nbsp;&nbsp;
<img src="theme/velopiter/images/readlocked<?php echo img_ext; ?>" alt="Тема закрыта" />&nbsp;Тема закрыта&nbsp;&nbsp;
<img src="theme/velopiter/images/moved<?php echo img_ext; ?>" alt="Тема перенесена в другой форум" />&nbsp;Тема перенесена в другой форум
</fieldset>
