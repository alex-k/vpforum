...
if (_uid === '_uid') {
	...
	switch ($section) {
		...
		case 'boardusage':
		case 'readingposting':
			$file = '/home/activeinfo/velopiter.spb.ru/public_html/forum/theme/velopiter/help/'. $section .'.hlp';
			$return_top = '<div class="GenText ac">[ <a href="index.php?t=help_index&amp;'._rsid.'">Возврат на главную страницу помощи</a> ]</div>';
			break;
		default:
			$file = '/home/activeinfo/velopiter.spb.ru/public_html/forum/theme/velopiter/help/faq_index.hlp';
			$return_top = '';
	}

	ses_update_status($usr->sid, 'Чтение <a href="index.php?t=help_index">F.A.Q.</a>');
	$TITLE_EXTRA = ': F.A.Q.';
