...
<?php echo $first_unread_message_link.$subscribe_status.$bookmark_status; ?>
 ...
 <?php echo ($FUD_OPT_3 & 2 ? '' : '<a href="index.php?t=tree&amp;th='.$th.'&amp;'._rsid.'"><img title="древовидный вид" alt="древовидный вид" src="theme/vp1/images/tree_view.gif" /></a>&nbsp;'); ?><a href="index.php?t=post&amp;frm_id=<?php echo $frm->forum_id; ?>&amp;<?php echo _rsid; ?>"><img alt="Создать новую тему" src="theme/vp1/images/new_thread.gif" /></a><?php echo ((!($frm->thread_opt & 1) || $perms & 4096) ? '&nbsp;<a href="index.php?t=post&amp;th_id='.$th.'&amp;reply_to='.$frm->root_msg_id.'&amp;'._rsid.'&amp;start='.$_GET['start'].'"><img src="theme/vp1/images/post_reply.gif" alt="Отправить ответ" /></a>' : ''); ?>
 </td>
...
<tr><td class="MsgR1 fb '.(!$quick_reply_collapsed ? 'MsgSubText' : '' )  .'">'.($quick_reply_collapsed ? '<img src="theme/vp1/images/max'.img_ext.'" alt="+" title="Максимайз" class="collapsable" />' : '' )  .' быстрый ответ</td></tr>
...
<td class="vt">
'.$page_pager.'&nbsp;</td>
<td class="GenText ar vb nw">'.($FUD_OPT_3 & 2 ? '' : '<a href="index.php?t=tree&amp;th='.$th.'&amp;'._rsid.'"><img title="древовидный вид" alt="древовидный вид" src="theme/vp1/images/tree_view.gif" /></a>&nbsp;'); ?><a href="index.php?t=post&amp;frm_id=<?php echo $frm->forum_id; ?>&amp;<?php echo _rsid; ?>"><img alt="Создать новую тему" src="theme/vp1/images/new_thread.gif" /></a><?php echo (!$quick_reply_enabled && (!($frm->thread_opt & 1) || $perms & 4096) ? '&nbsp;<a href="index.php?t=post&amp;th_id='.$th.'&amp;reply_to='.$frm->root_msg_id.'&amp;'._rsid.'&amp;start='.$_GET['start'].'"><img src="theme/vp1/images/post_reply.gif" alt="Отправить ответ" /></a>' : ''); ?></td>
</tr>
...
<div class="ar SmallText"><?php echo ($FUD_OPT_2 & 1048576 ? '[ <a href="index.php?t=help_index&amp;section=boardusage#syndicate">Сформировать XML</a> ] [ <a href="feed.php?mode=m&amp;th='.$th.'&amp;basic=1"><img src="theme/vp1/images/rss.gif" title="Сформировать XML" alt="RSS" /></a> ]' : ''); ?> <?php echo ($FUD_OPT_2 & 2097152 ? '[ <a href="'.$GLOBALS['WWW_ROOT'].'pdf.php?th='.$th.'&amp;'._rsid.'"><img src="theme/vp1/images/pdf.gif" title="Сформировать PDF для печати" alt="PDF" /></a> ]' : ''); ?></div>
...
/* <![CDATA[ */
min_max_posts('theme/vp1/images', '<?php echo img_ext; ?>', 'Минимайз', 'Максимайз');
