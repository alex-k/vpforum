...
<tr>'.$tabs.'</tr>
	...
	<td class="nw GenText"><a href="index.php?t=showposts&amp;id='.$r[1].'&amp;'._rsid.'"><img src="theme/vp1/images/show_posts.gif" alt="Show Posts" /></a>'.((_uid && $FUD_OPT_1 & 1024) ? '&nbsp;<a href="index.php?t=ppost&amp;'._rsid.'&amp;toi='.$r[1].'"><img src="theme/vp1/images/msg_pm.gif" alt="PM" /></a>' : '' ) .(!empty($r[4]) ? '&nbsp;<a href="'.$r[4].'"><img src="theme/vp1/images/homepage.gif" alt="Home"/></a>' : '' ) .($FUD_OPT_2 & 1073741824 ? '&nbsp;<a href="index.php?t=email&amp;toi='.$r[1].'&amp;'._rsid.'" rel="nofollow"><img src="theme/vp1/images/msg_email.gif" alt="E-mail" /></a>' : '' ) .'</td>
</tr>';
			} while (($r = db_rowarr($c)));
		} else {
			$refered_entry_data = '<tr><td colspan="4" class="RowStyleB">Никто пока не был приглашен.</th></tr>';
		}
		unset($c);
	} else {
		invl_inp_err();
...
<tr><th>Пришедшие по ссылкам-рефералам, размещённым участником <b><a href="index.php?t=usrinfo&amp;id=<?php echo $p_user[0]; ?>&amp;<?php echo _rsid; ?>" class="thLnk"><?php echo $p_user[1]; ?></a></b></th><th class="ac nw">Сообщения</th><th class="ac nw">Дата регистрации</th><th class="ac nw">Действие</th></tr>
