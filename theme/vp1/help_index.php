...
if (_uid === '_uid') {
	...
	switch ($section) {
		...
		case 'boardusage':
		case 'readingposting':
			$file = '/home/activeinfo/velopiter.spb.ru/public_html/forum/theme/vp1/help/'. $section .'.hlp';
			$return_top = '<div class="GenText ac">[ <a href="index.php?t=help_index&amp;'._rsid.'">Возврат на главную страницу помощи</a> ]</div>';
			break;
		default:
			$file = '/home/activeinfo/velopiter.spb.ru/public_html/forum/theme/vp1/help/faq_index.hlp';
			$return_top = '';
	}
