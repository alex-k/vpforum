...
<tr>'.$tabs.'</tr>
	...
	while ($r = db_rowarr($c)) {
		...
		$obj = new stdClass();
		$obj->login = $r[1];
		$uc_online = (!$r[3] && ($r[2] + $LOGEDIN_TIMEOUT * 60) > __request_timestamp__) ? '<img src="theme/vp1/images/online'.img_ext.'" alt="онлайн" title="онлайн" />' : '<img src="theme/vp1/images/offline'.img_ext.'" alt="оффлайн" title="оффлайн" />';
